    ...
    <header className="bg-brand-background-alt/80 dark:bg-gray-800/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-4">
            ...
            {user ? (
              <button onClick={handleLogout} className="flex items-center text-brand-text-dark dark:text-gray-200 font-semibold hover:text-brand-primary dark:hover:text-white transition-colors duration-300">
      ...
      {isOpen && (
        <div className="md:hidden bg-brand-background-alt dark:bg-gray-800 pb-4">
          <nav className="flex flex-col items-center space-y-4">
            ...
            {user ? (
               <button onClick={handleLogout} className="text-brand-text-dark dark:text-gray-200 hover:text-brand-primary dark:hover:text-white transition-colors duration-300 font-semibold w-4/5 text-center py-2">
                Logout
              </button>
            ) : (
